# creando una funcion que nos devuelva los numeros primos entre el 0 y el que se le pase
# crear una funcion que verifique si un numero es primo
def es_primo(num):
    # verficamos que el numero pasado no pueda dividirse
    # pro ningun numero entre 2 y ese mismo numero -1
...
# creamos una funcion que decuelva una lista con todos los primos
